...
Vous trouverez aussi dans ce dossier les archives pré-compilé du projet que vous n'aurez plus qu'à déposez dans vos déploiements.Dans les fichiers déjà compilés, les utilisateurs mysql sont :
